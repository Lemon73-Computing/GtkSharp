...
namespace Gdk
{
    ...
    public partial class Window
    {
        ...
        static readonly d_gdk_window_get_background_pattern gdk_window_get_background_pattern = FuncLoader.LoadFunction<d_gdk_window_get_background_pattern>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_get_background_pattern"));
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        delegate void d_gdk_window_set_background_pattern(IntPtr raw, IntPtr pattern);
        static readonly d_gdk_window_set_background_pattern gdk_window_set_background_pattern = FuncLoader.LoadFunction<d_gdk_window_set_background_pattern>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_set_background_pattern"));
        ...
        static readonly d_gdk_window_get_children gdk_window_get_children = FuncLoader.LoadFunction<d_gdk_window_get_children>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_get_children"));
        ...
        static readonly d_gdk_window_set_icon_list gdk_window_set_icon_list = FuncLoader.LoadFunction<d_gdk_window_set_icon_list>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_set_icon_list"));
        ...
        static readonly d_gdk_window_destroy gdk_window_destroy = FuncLoader.LoadFunction<d_gdk_window_destroy>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_destroy"));
        ...
        static readonly d_gdk_window_get_user_data gdk_window_get_user_data = FuncLoader.LoadFunction<d_gdk_window_get_user_data>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_get_user_data"));
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        delegate void d_gdk_window_set_user_data(IntPtr raw, IntPtr user_data);
        static readonly d_gdk_window_set_user_data gdk_window_set_user_data = FuncLoader.LoadFunction<d_gdk_window_set_user_data>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_set_user_data"));
        ...
        static readonly d_gdk_window_add_filter gdk_window_add_filter = FuncLoader.LoadFunction<d_gdk_window_add_filter>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_add_filter"));
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        delegate void d_gdk_window_remove_filter(IntPtr handle, GdkSharp.FilterFuncNative wrapper, IntPtr data);
        static readonly d_gdk_window_remove_filter gdk_window_remove_filter = FuncLoader.LoadFunction<d_gdk_window_remove_filter>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gdk), "gdk_window_remove_filter"));
