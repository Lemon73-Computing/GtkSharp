...
namespace Gtk
{
    ...
    public partial class RadioMenuItem
    {
        ...
        static readonly d_gtk_radio_menu_item_new_with_mnemonic gtk_radio_menu_item_new_with_mnemonic = FuncLoader.LoadFunction<d_gtk_radio_menu_item_new_with_mnemonic>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_radio_menu_item_new_with_mnemonic"));
        ...
        static readonly d_gtk_radio_menu_item_get_group gtk_radio_menu_item_get_group = FuncLoader.LoadFunction<d_gtk_radio_menu_item_get_group>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_radio_menu_item_get_group"));
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        delegate void d_gtk_radio_menu_item_set_group(IntPtr raw, IntPtr list);
        static readonly d_gtk_radio_menu_item_set_group gtk_radio_menu_item_set_group = FuncLoader.LoadFunction<d_gtk_radio_menu_item_set_group>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_radio_menu_item_set_group"));
