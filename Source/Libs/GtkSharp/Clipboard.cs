...
namespace Gtk
{
    ...
    public partial class Clipboard
    {
        ...
        static readonly d_gtk_clipboard_set_with_data gtk_clipboard_set_with_data = FuncLoader.LoadFunction<d_gtk_clipboard_set_with_data>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_clipboard_set_with_data"));
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        ...
        static readonly d_gtk_clipboard_set_with_owner gtk_clipboard_set_with_owner = FuncLoader.LoadFunction<d_gtk_clipboard_set_with_owner>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_clipboard_set_with_owner"));
        ...
        static readonly d_gtk_clipboard_wait_for_rich_text gtk_clipboard_wait_for_rich_text = FuncLoader.LoadFunction<d_gtk_clipboard_wait_for_rich_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_clipboard_wait_for_rich_text"));
        ...
        static readonly d_gtk_clipboard_request_rich_text gtk_clipboard_request_rich_text = FuncLoader.LoadFunction<d_gtk_clipboard_request_rich_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_clipboard_request_rich_text"));
