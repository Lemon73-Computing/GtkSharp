...
namespace Gtk
{
    ...
    public partial class Stock
    {
        ...
        static readonly d_gtk_stock_list_ids gtk_stock_list_ids = FuncLoader.LoadFunction<d_gtk_stock_list_ids>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_stock_list_ids"));
