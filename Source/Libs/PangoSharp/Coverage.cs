...
namespace Pango
{
    ...
    public partial class Coverage
    {
        ...
        static readonly d_pango_coverage_to_bytes pango_coverage_to_bytes = FuncLoader.LoadFunction<d_pango_coverage_to_bytes>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_coverage_to_bytes"));
