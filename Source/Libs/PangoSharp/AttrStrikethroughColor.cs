...
namespace Pango
{
    ...
    public class AttrStrikethroughColor : Attribute
    {
        ...
        static readonly d_pango_attr_strikethrough_color_new pango_attr_strikethrough_color_new = FuncLoader.LoadFunction<d_pango_attr_strikethrough_color_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_attr_strikethrough_color_new"));
