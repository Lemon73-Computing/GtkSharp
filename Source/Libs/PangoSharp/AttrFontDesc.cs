...
namespace Pango
{
    ...
    public class AttrFontDesc : Attribute
    {
        ...
        static readonly d_pango_attr_font_desc_new pango_attr_font_desc_new = FuncLoader.LoadFunction<d_pango_attr_font_desc_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_attr_font_desc_new"));
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        delegate IntPtr d_pango_font_description_copy(IntPtr raw);
        static readonly d_pango_font_description_copy pango_font_description_copy = FuncLoader.LoadFunction<d_pango_font_description_copy>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_font_description_copy"));
