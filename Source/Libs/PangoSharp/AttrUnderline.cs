...
namespace Pango
{
    ...
    public class AttrUnderline : Attribute
    {
        ...
        static readonly d_pango_attr_underline_new pango_attr_underline_new = FuncLoader.LoadFunction<d_pango_attr_underline_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Pango), "pango_attr_underline_new"));
